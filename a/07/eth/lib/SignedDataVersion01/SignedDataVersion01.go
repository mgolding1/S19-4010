...
//
// Solidity: function getData(_app uint256, _name uint256) constant returns(bytes32)
...
//
// Solidity: function getData(_app uint256, _name uint256) constant returns(bytes32)
func (_SignedDataVersion01 *SignedDataVersion01Session) GetData(_app *big.Int, _name *big.Int) ([32]byte, error) {
...
//
// Solidity: function getData(_app uint256, _name uint256) constant returns(bytes32)
func (_SignedDataVersion01 *SignedDataVersion01CallerSession) GetData(_app *big.Int, _name *big.Int) ([32]byte, error) {
	return _SignedDataVersion01.Contract.GetData(&_SignedDataVersion01.CallOpts, _app, _name)
}
...
// SetData is a paid mutator transaction binding the contract method 0x8c58ae24.
//
// Solidity: function setData(_app uint256, _name uint256, _data bytes32) returns()
func (_SignedDataVersion01 *SignedDataVersion01Transactor) SetData(opts *bind.TransactOpts, _app *big.Int, _name *big.Int, _data [32]byte) (*types.Transaction, error) {
	return _SignedDataVersion01.contract.Transact(opts, "setData", _app, _name, _data)
}

// SetData is a paid mutator transaction binding the contract method 0x8c58ae24.
//
// Solidity: function setData(_app uint256, _name uint256, _data bytes32) returns()
func (_SignedDataVersion01 *SignedDataVersion01Session) SetData(_app *big.Int, _name *big.Int, _data [32]byte) (*types.Transaction, error) {
	return _SignedDataVersion01.Contract.SetData(&_SignedDataVersion01.TransactOpts, _app, _name, _data)
}

// SetData is a paid mutator transaction binding the contract method 0x8c58ae24.
//
// Solidity: function setData(_app uint256, _name uint256, _data bytes32) returns()
func (_SignedDataVersion01 *SignedDataVersion01TransactorSession) SetData(_app *big.Int, _name *big.Int, _data [32]byte) (*types.Transaction, error) {
	return _SignedDataVersion01.Contract.SetData(&_SignedDataVersion01.TransactOpts, _app, _name, _data)
}
...
// FilterDataChange is a free log retrieval operation binding the contract event 0xc9bbb9d40eb6b265e9e7f7c2c367f761494e11148c80a704ed4a44184fe4313a.
//
// Solidity: e DataChange(App uint256, Name uint256, Value bytes32, By address)
...
// WatchDataChange is a free log subscription operation binding the contract event 0xc9bbb9d40eb6b265e9e7f7c2c367f761494e11148c80a704ed4a44184fe4313a.
//
// Solidity: e DataChange(App uint256, Name uint256, Value bytes32, By address)
