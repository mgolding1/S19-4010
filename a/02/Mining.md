...
If you have already cloned the S19-4010 set of information you will need to update it to current.
You may have made changes already.

```
	cd ~/go/src/github.com/Univ-Wyo-Education/S19-4010
	git stash
	git pull
	git checkout -b hw02
```
...
+> go test
	...
	PASS
	ok  	github.com/Univ-Wyo-Education/S19-4010/a/02/mine	0.914s
```
